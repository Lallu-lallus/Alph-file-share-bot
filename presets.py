...
class Presets(object):
    CAPTION_TEXT_DOC = "\n\n<b>File Name:</b> {}\n\n<b>Format:</b> {}\n<b>Size:</b> {}"
    CAPTION_TEXT_VID = "\n\n<b>File Name:</b> {}\n\n<b>Size:</b> {}"
    ASK_PM_TEXT = "<b>Hey <b>{}<\b>👇നിങ്ങൾ ചോദിച്ച മൂവി ലഭിക്കാൻ താഴെ കാണുന്ന ബട്ടണിൽ ക്ലിക്ക് ചെയ്യുക😇</b>"
    ...
    MEDIA_SEND_TEXT = "<code>Hey <b>{}<\b> THAANKAL CHODICHA FILE PM SEND CHEYTHITTUNDE THAZHE KAANJNNA BITTON CLICK CHYTHU DOWNLOAD CHEYYU 🥳</code>"
